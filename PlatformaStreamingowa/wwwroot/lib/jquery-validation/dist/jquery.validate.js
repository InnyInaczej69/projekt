...
$.extend( $.validator, {
	...
	messages: {
		...
		dateISO: "Proszę podać prawidłową datę (ISO).",
		number: "Proszę podać prawidłową liczbę.",
		digits: "Proszę wpisywać tylko cyfry.",
		equalTo: "Proszę wpisać ponownie tę samą wartość.",
		...
		rangelength: $.validator.format( "Proszę podać wartość od {0} do {1} znaków." ),
		range: $.validator.format( "Proszę podać wartość od {0} do {1}." ),
